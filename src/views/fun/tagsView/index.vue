 ...
 * @LastEditTime: 2024-11-25 17:15:37
 * @FilePath: \vue-next-admin-master\src\views\fun\tagsView\index.vue
 * @Description: 
 * 
...
<template>
	<div class="fun-tagsview layout-pd">
		...
		<svg-icons icon="login-main" class="ml-8 bg-Aside" style="font-size: 150px;"></svg-icons>
	</div>
</template>
